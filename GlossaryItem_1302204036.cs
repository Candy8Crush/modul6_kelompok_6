...
{
    class GlossaryItem_1302204036
    {
        public GlossaryClass glossary { get; set; }

        public void ReadJSON()
        {
            string fileName = "jurnal6_3_1302204036.json";

            string jsonString = File.ReadAllText(fileName);

            GlossaryItem_1302204036 jsonData = JsonSerializer.Deserialize<GlossaryItem_1302204036>(jsonString);

            this.glossary = jsonData.glossary;

            Console.WriteLine("Starting to give out Gloss Entry");
